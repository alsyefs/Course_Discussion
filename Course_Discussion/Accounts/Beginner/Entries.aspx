<%@ Page Title="Entries" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entries.aspx.cs" Inherits="Course_Discussion.Accounts.Beginner.Entries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <asp:Label ID="lblEntry" runat="server" Text="Label" Visible="False" Font-Size="Large"></asp:Label>
    <br />
    ...
    &nbsp;
    <br />
    <asp:Button ID="btnAddEntry" runat="server" Text="Add New Entry" Height="41px" Width="169px" OnClick="btnAddEntry_Click" BackColor="Green" Font-Bold="True" Font-Size="Medium" class="btn btn-primary"/>
    &nbsp;&nbsp;
