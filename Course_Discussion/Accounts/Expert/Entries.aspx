<%@ Page Title="Entries" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entries.aspx.cs" Inherits="Course_Discussion.Accounts.Expert.Entries" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    &nbsp;
    <br />
    <asp:Button ID="btnAddEntry" runat="server" Text="Add New Entry" Height="37px" Width="167px" OnClick="btnAddEntry_Click" BackColor="Green" Font-Bold="True" Font-Size="Medium" class="btn btn-primary" />
    &nbsp;&nbsp;
