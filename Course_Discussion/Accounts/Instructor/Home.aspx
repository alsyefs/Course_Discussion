<%@ Page Title="Home" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Course_Discussion.Accounts.Instructor.Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="grdDiscussions" runat="server" AllowPaging="True" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"  OnPageIndexChanging="grdDiscussions_PageIndexChanging"   OnSelectedIndexChanged ="grdDiscussions_SelectedIndexChanged">
        ...
        <Columns>
            ...
            <asp:HyperLinkField Text="View" DataNavigateUrlFields="id" SortExpression="id" DataNavigateUrlFormatString="~/Accounts/Instructor/Entries.aspx?id={0}" />
            
            <asp:HyperLinkField DataNavigateUrlFields="id" DataNavigateUrlFormatString="~/Accounts/Instructor/Terminate.aspx?id={0}" SortExpression="id" Text="Terminate" />
